<!-- Modal Ver ciudadano -->
<div class="modal fade" id="modalVerCiudadano" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header header-primary">
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#InfoCiudadanos">Datos del ciudadano</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#Reportes">Reportes registrados</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#ReporteNuevo">Reporte nuevo</a>
          </li>
        </ul>
      ...
      <div class="modal-body">
        <div class="tab-content" id="myTabContent">
          ...
          <!-- Datos de ciudadano-->
          <div class="tab-pane fade active show" id="InfoCiudadanos">
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  <form class="row" id="formDatosCiudadano" name="formDatosCiudadano">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control valid validText" id="txtApePaternoEdit" name="txtApePaternoEdit" required="">
                    </div>
                    <div class="form-group col-md-3">
                      <label for="txtApeMaternoEdit">Apellido materno</label>
                      <input type="text" class="form-control valid validText" id="txtApeMaternoEdit" name="txtApeMaternoEdit">
                    </div>
                    <br>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control valid validEmail" id="txtEmailEdit" name="txtEmailEdit">
                    </div>
                    <div class="form-group col-md-6">
          ...
          <div class="tile mb-4 tab-pane fade" id="Reportes">
          ...
          <!-- Reporte nuevo -->
          <div class="tab-pane fade" id="ReporteNuevo">
            <div class="modal-body">
              <div class="col-md-12">
                <div class="tile">
                  <div class="tile-body">
                    <form class="row" id="formReporteCiudadano" name="formReporteCiudadano">
                      <input type="hidden" id="id_ciudadanoRN" name="id_ciudadanoRN" value="">
                      <input type="hidden" id="TelefonoRN" name="TelefonoRN" value="">
                      <div class="form-group col-md-3">
                            ...
                            <blockquote class="card-blockquote">
                              <table>
                                ...
                                <tbody class="text-white">
                                  <tr>
                                    <td id="celNombreRN"></td>
                                  </tr>
                                  <tr>
                                    <td id="celTipoContactoRN"></td>
                                  </tr>
                                  <tr>
                                    <td id="celTelefonoRN"></td>
                                  </tr>
                                  <tr>
                                    <td id="celCalleRN"></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td id="celCodigoPostalRN"></td>
                                  </tr>
                                  <tr>
                                    <td id="celMapaRN"><br></td>
                                  </tr>
                                </tbody>
                              </table>
                            </blockquote>
                      ...
                      <div class="form-group col-md-9">
                        <label for="listTramitesServicios">Trámite o servicio</label>
                        <select class="form-control" data-live-search="true" id="listTramitesServicios" name="listTramitesServicios"></select>
                        <br><br>
                        <label for="txtDetalleReporte">Detalle del reporte</label>
                        <textarea class="form-control" id="txtDetalleReporte" name="txtDetalleReporte" rows="2" type="text"></textarea>
                        <br>
                        <label for="txtNumSolicitudes">Número de reparaciones solicitadas</label>
                        <input type="text" class="form-control" id="txtNumSolicitudesReporteNuevo" name="txtNumSolicitudes" onkeypress="return controlTag(event);">
                         <br>
                        ...
                        <div class="row divnuevaUbiReporte" id="NuevaUbicacionReporte" name="NuevaUbicacionReporte">
                          <br>
                          <br>
                          <div class="form-group col-md-6">
                            <label for="listColoniaReporteNuevo">Colonia</label>
                            <select class="form-control" data-live-search="true" id="listColoniaReporteNuevo" name="listColoniaReporteNuevo"></select>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="listCalleReporteNuevo">Calle</label>
                            <select class="form-control" data-live-search="true" id="listCalleReporteNuevo" name="listCalleReporteNuevo"></select>
                          </div>
                          <br>
                          <div class="form-group col-md-6">
                            <label for="txtNumExteriorReporteNuevo">No. Exterior</label>
                            <input type="text" class="form-control" id="txtNumExteriorReporteNuevo" name="txtNumExteriorReporteNuevo">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="txtNumInteriorReporteNuevo">No. Interior</label>
                            <input type="text" class="form-control" id="txtNumInteriorReporteNuevo" name="txtNumInteriorReporteNuevo">
                          </div>
                          <br>
                          <div class="form-group col-md-6">
                            <label for="listCalle1ReporteNuevo">Entre calle 1</label>
                            <select class="form-control" data-live-search="true" id="listCalle1ReporteNuevo" name="listCalle1ReporteNuevo"></select>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="listCalle2ReporteNuevo">Entre calle 2</label>
                            <select class="form-control" data-live-search="true" id="listCalle2ReporteNuevo" name="listCalle2ReporteNuevo"></select>
                          </div>
                          <br>
                          <div class="form-group col-md-12">
                            <label for="txtReferenciasReporteNuevo">Referencias</label>
                            <textarea class="form-control" id="txtReferenciasReporteNuevo" name="txtReferenciasReporteNuevo" rows="2" type="text"></textarea>
                          </div>
                          <br>
                          <div class="form-group col-md-12 text-right">
                            <button class="btn btn-primary" type="submit">
                              <i class="fa fa-fw fa-lg fa-check-circle"></i>                         Crear reporte
                            </button>
                          </div>
                        </div>
                      </div>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header header-primary" >
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#DatosReporte">Datos del reporte</a>
          </li>
          <li class="nav-item">
              ...
              <div class="tile mb-4">
                <div class="tile-body">
                  <form class="row" id="formVerReporteCiudadano" name="formVerReporteCiudadano">
                    ...
                    <input type="hidden" id="idCiudadanoVR" name="idCiudadanoVR" value="">
                    <div class="form-group col-md-3">
                      <div class="card mb-3 text-white bg-info">
                        <div class="card-body">
                          <blockquote class="card-blockquote">
                    ...
                    <div class="form-group col-md-9">
                      ...
                      <br>
                      <fieldset>
                        <label class="control-label" for="listTramitesServiciosVR">Trámite o servicio</label>
                        <select class="form-control" data-live-search="true" id="listTramitesServiciosVR" name="listTramitesServiciosVR"></select>
                      </fieldset>
                      <br>
                      <fieldset>
                        <label class="control-label" for="txtDetalleReporteVR">Detalle del reporte</label>
                        <textarea class="form-control" id="txtDetalleReporteVR" name="txtDetalleReporteVR" rows="4" type="text" ></textarea>
                      </fieldset>
                      <br>
                      <fieldset>
                        <label class="control-label" for="txtNumSolicitudesVR">Número de reparaciones solicitadas</label>
                        <input type="text" class="form-control" id="txtNumSolicitudesVR" name="txtNumSolicitudesVR" onkeypress="return controlTag(event);" >
                      </fieldset>
                      <br>
                      <div class="bs-component">
                        <div class="alert alert-dismissible alert-info text-center">
                      ...
                      <fieldset>
                        <label class="control-label" for="txtColoniaTicket">Colonia</label>
                        <input type="text" class="form-control" id="txtColoniaTicket" name="txtColoniaTicket" >
                      </fieldset>
                      <br>
                      <fieldset>
                        <label class="control-label" for="txtCalleTicket">Calle</label>
                        <input type="text" class="form-control" id="txtCalleTicket" name="txtCalleTicket" >
                      </fieldset>
                      <br>
                      <div class="row">
                        <div class="form-group col-md-6">
                      ...
                      <br>
                      <fieldset>
                        <label class="control-label" for="txtCalle1Ticket">Entre calle 1</label>
                        <input type="text" class="form-control" id="txtCalle1Ticket" name="txtCalle1Ticket" >
                      </fieldset>
                      <br>
                      <fieldset>
                        <label class="control-label" for="txtCalle2Ticket">Entre calle 2</label>
                        <input type="text" class="form-control" id="txtCalle2Ticket" name="txtCalle2Ticket" >
                      </fieldset>
                      <br>
                      <fieldset>
                      ...
                      <div class="row text-right">
                        <div class="form-group col-md-12">
                          ...
                          &nbsp;&nbsp;&nbsp;
                          <button type="button" class="btn btn-secondary" onclick="fntAtras();">
