  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title h4">Permisos de roles - <?= $data['rol'] ?></h5>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="toggle-flip">
                          <label>
                              <input type="checkbox" id="modulo_<?= $idmod; ?>" name="modulos[<?= $i; ?>][r]" <?= $rCheck ?>><span class="flip-indecator" data-toggle-on="ON" data-toggle-off="OFF"></span>
                          </label>
                        </div>
                      </td>
                      <td>
