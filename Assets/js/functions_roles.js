...
document.addEventListener("DOMContentLoaded", function(){
	...
	tableRoles = $('#tableRoles').dataTable( {
		...
		"columns":[
			{"data":"id_permiso", "width": "5%"},
			{"data":"permiso", "width": "40%"},
	...
	formRol.onsubmit = function(e) {
		...
		var strNombre = document.querySelector('#txtRol').value;
...
function fntEditRol(id_permiso){
	...
	request.onreadystatechange = function(){
		if(request.readyState == 4 && request.status == 200){
			...
			if(objData.status)
			{
				document.querySelector("#idRol").value = objData.data.id_permiso;
				document.querySelector("#txtRol").value = objData.data.permiso;
...
function fntPermisos(id_permiso)
{
	var	idrol = id_permiso;
	var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
